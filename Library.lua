...
local Library = {
    ...
    Scheme = {
        ...
        MainColor = Color3.fromRGB(42, 42, 42),
...
do
    ...
    WatermarkBackground.Active = true
    ...
    function Window:AddTab(...)
        ...
        function Tab:UpdateWarningBox(Info)
            ...
            Library.Registry[WarningBox].BackgroundColor3 = function()
                local isNormal = Tab.WarningBox.IsNormal == true
                return isNormal and Library.Scheme.BackgroundColor or Color3.fromRGB(127, 0, 0)
            end
            
            Library.Registry[WarningBox].BorderColor3 = function()
                local isNormal = Tab.WarningBox.IsNormal == true
                return isNormal and Library.Scheme.OutlineColor or Color3.fromRGB(255, 50, 50)
            end
            
            Library.Registry[WarningTitle].TextColor3 = function()
                local isNormal = Tab.WarningBox.IsNormal == true
                return isNormal and Library.Scheme.FontColor or Color3.fromRGB(255, 50, 50)
            end
            
            Library.Registry[WarningStroke].Color = function()
                local isNormal = Tab.WarningBox.IsNormal == true
                return isNormal and Library.Scheme.OutlineColor or Color3.fromRGB(169, 0, 0)
            end
        end
